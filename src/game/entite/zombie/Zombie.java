...
public class Zombie implements EntiteInterface {
	private int x;
	private int y;
	private int speed;
	private int size;
	...
	private Zombie(int x, int y, int speed, int health, int damage, int size) {
		// IDem ,couleur fixe et taille
		this.x = x;
		this.y = y;
		this.speed = speed;
		this.color = new Color(52, 73, 94);
		this.health = health;
		this.damage = damage;
		this.size = size;
	}

	public static Zombie spawnZombie(int x_data, int y_data) {
		return new Zombie(x_data, y_data, -2, 200, 20, 100);
	}
	...
	public String toString() {
		return "zombie [health=" + health + " coordonnee : " + x + "   " + y + " ]";
	}
