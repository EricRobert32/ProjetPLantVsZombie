...
public class DuckyTubeZombie implements EntiteInterface {
	private int x;
	private int y;
	private int speed;
	private int size;
	...
	private DuckyTubeZombie(int x, int y, int speed, int health, int damage, int size) {
		// IDem ,couleur fixe et taille
		this.x = x;
		this.y = y;
		this.speed = speed;
		this.color = new Color(8, 152, 163);
		this.health = health;
		this.damage = damage;
		this.size = size;
	}

	public static DuckyTubeZombie spawnZombie(int x_data, int y_data) {
		return new DuckyTubeZombie(x_data, y_data, -2, 200, 20, 100);
	}
	...
	public String toString() {
		return "DuckuTubeZombie [health=" + health + " coordonnee : " + x + "   " + y + " ]";
	}
	...
	// Methode Prendre damage ? void take_damage (plante dmg){health=health-dmg;}
